    ...
    <div className="bg-white p-6 rounded-xl shadow-lg transition-all hover:shadow-xl">
      <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-6">
        <div className="flex-shrink-0">
          <img
            className="h-24 w-24 rounded-full object-cover ring-4 ring-emerald-200"
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-md text-gray-500 mt-1">
                DOB: {new Date(patient.dateOfBirth).toLocaleDateString()} ({calculateAge(patient.dateOfBirth)} years old)
