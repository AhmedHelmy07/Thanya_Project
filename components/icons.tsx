...
// For this to work, place your logo files in a `public/images/` directory at the root of your project.
...
export const MedicationIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H4a1 1 0 00-1 1v4a1 1 0 001 1h1m14 0h1a1 1 0 001-1v-4a1 1 0 00-1-1h-1m-6 0a2 2 0 100 4 2 2 0 000-4z" />
  </svg>
);
...
export const VitalsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const DeviceIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 17.25v1.007a3 3 0 01-.375 1.506H5.25a3 3 0 01-3-3V11.25a3 3 0 013-3h12.75a3 3 0 013 3v6.75a3 3 0 01-3 3h-3.375c-.131 0-.261.01-.375.029m-3.75 0a3 3 0 01-3-3V6.75a3 3 0 013-3h3.75a3 3 0 013 3v3.75m-3.75 0h3.75M9 13.5h3.75" />
  </svg>
);
